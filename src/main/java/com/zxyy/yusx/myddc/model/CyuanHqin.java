...
public class CyuanHqin implements Serializable {
    private String id;

    private Integer wsheng;

    private Integer sshi;

    private Integer rcyuan;

    private Integer sddti;
    ...
    public Integer getSshi() {
        return sshi;
    }

    public void setSshi(Integer sshi) {
        this.sshi = sshi;
    }

    public Integer getRcyuan() {
        return rcyuan;
    }

    public void setRcyuan(Integer rcyuan) {
        this.rcyuan = rcyuan;
    }

    public Integer getSddti() {
        return sddti;
    }

    public void setSddti(Integer sddti) {
        this.sddti = sddti;
    }
