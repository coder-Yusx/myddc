...
public class CyuanYsheng implements Serializable {
    private String id;
    ...
    public Integer getTdu() {
        return tdu;
    }

    public void setTdu(Integer tdu) {
        this.tdu = tdu;
    }

    public Integer getJsu() {
        return jsu;
    }

    public void setJsu(Integer jsu) {
        this.jsu = jsu;
    }

    public Integer getYde() {
        return yde;
    }

    public void setYde(Integer yde) {
        this.yde = yde;
    }
